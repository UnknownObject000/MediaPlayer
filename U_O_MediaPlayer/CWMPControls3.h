...
public:
	...
	{
		static BYTE parms[] = VTS_I4;
		InvokeHelper(0x40, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, lStep);
	}
	...
	{
		long result;
		InvokeHelper(0x45, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
		return result;
	}
	...
	{
		CString result;
		InvokeHelper(0x47, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
		return result;
	}
